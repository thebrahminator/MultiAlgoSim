...
void compute_stat(char* file_name, int size, int percent, char* op_fname){
    ...
    fprintf(out_file, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d\n", percent, trace_stat.total_count, 
    trace_stat.read_count, trace_stat.write_count, trace_stat.total_hit, trace_stat.read_hit, 
    trace_stat.write_hit, trace_stat.total_miss, trace_stat.read_miss, trace_stat.write_miss);
